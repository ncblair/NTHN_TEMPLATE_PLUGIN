...
int main()
{
    ...
    headerFile << "static const std::array<juce::NormalisableRange<float>, PARAM::TOTAL_NUMBER_PARAMETERS> PARAMETER_RANGES {\n";
    for (const auto &p : params)
    ...
    headerFile << "static const std::array<std::vector<juce::String>, PARAM::TOTAL_NUMBER_PARAMETERS> PARAMETER_TO_STRING_ARRS {\n";
    for (const auto &p : params)
    {
